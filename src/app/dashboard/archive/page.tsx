  ...
  return (
    <div className="flex h-full relative">
      ...
      <div className="flex-1 bg-white dark:bg-gray-800 min-w-0">
        {selectedEmail ? (
          <EmailView email={selectedEmail} folder="archive" />
        ) : (
          <div className="h-full flex items-center justify-center bg-slate-50 dark:bg-slate-900">
            <div className="text-center">
              <div className="w-20 h-20 bg-gradient-to-br from-purple-100 to-indigo-100 dark:from-purple-900/30 dark:to-indigo-900/30 rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-sm">
